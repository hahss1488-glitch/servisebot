...
SERVICES = {
    ...
    10: {"name": "🛣️ Дальняк", "kind": "distance", "rate_per_km": 7, "priority": 2, "order": 4},
    11: {"name": "🛣️ Дальняя поездка", "priority": 2, "order": 5, "kind": "group", "children": [30, 31, 32, 33]},
    ...
    39: {"name": "🚚 Перемещение ТС", "priority": 4, "order": 14, "kind": "group", "children": [41, 42, 43, 44]},
    40: {"name": "🏙️ Вывод в город", "day_price": 31, "night_price": 25, "priority": 4, "order": 14},
